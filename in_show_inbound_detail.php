...
?>
  ...
  <div class="subject show">
    ...
    <div class="attributes">
      ...
      <dl>
        <dt>Trip Number:</dt>
        <dd class="strong"><?php echo h($inbound_head['tripNumber']); ?></dd>
      </dl>
      <dl>
        <dt>Note:</dt>
    ...
    <table class="list">
      ...
      <?php while($item = mysqli_fetch_assoc($item_set)) { ?>
        <tr>
          ...
          <td><a class="action" href="<?php echo 'lot_detail.php?id=' . h(u($inbound_head['inboundBOL'])) . '&lot=' . h(u($item['lotNumber'])); ?>"><?php echo h($item['lotNumber']); ?></a></td>
