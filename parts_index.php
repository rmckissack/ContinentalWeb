  ...
  <div class="pages listing">
    ...
    <div class="actions">
      ...
      <?php while($part = mysqli_fetch_assoc($part_set)) { ?>
        <tr>
          <!-- <td><?php echo h($part['PartNum']); ?></td> -->
          <td><a class="action" href="<?php echo 'parts_show.php?PartNum=' . h(u($part['PartNum'])); ?>"><?php echo h($part['PartNum']); ?></a></td>
          ...
          <td><a class="action" href="<?php echo 'parts_show.php?PartNum=' . h(u($part['PartNum'])); ?>">View</a></td>
          <td><a class="action" href="<?php echo 'parts_edit.php?PartNum=' . h(u($part['PartNum'])); ?>">Edit</a></td>
